...
class FieldModel extends BaseModel {
    ...
    public function saveData($type = 'add'){
        ...
        //字段集信息
        $fieldsetInfo=target('lhave/Fieldset')->getInfo($data['fieldset_id']);
        //获取字段类型属性
    ...
    public function delData($fieldId)
    {
        ...
        $fieldsetInfo = target('lhave/Fieldset')->getInfo($info['fieldset_id']);
     ...
     */
    public function htmlFieldFull($value,$data = null,$model = 'lhave/Field')
    {
        //获取字段属性
        $typeField=$this->typeField();
        //生成新配置
