...
--
-- 表的结构 `lhave_admin_group`
--

CREATE TABLE IF NOT EXISTS `lhave_admin_group` (
...
--
-- 转存表中的数据 `lhave_admin_group`
--

INSERT INTO `lhave_admin_group` (`group_id`, `name`, `base_purview`, `menu_purview`, `status`) VALUES
...
--
-- 表的结构 `lhave_admin_log`
--

CREATE TABLE IF NOT EXISTS `lhave_admin_log` (
...
--
-- 表的结构 `lhave_admin_user`
--

CREATE TABLE IF NOT EXISTS `lhave_admin_user` (
...
--
-- 转存表中的数据 `lhave_admin_user`
--

INSERT INTO `lhave_admin_user` (`user_id`, `group_id`, `username`, `password`, `nicename`, `email`, `status`, `level`, `reg_time`, `last_login_time`, `last_login_ip`) VALUES
(1, 1, 'lhave', '1638e33171c1ee666a19fd113421282a', '管理员', 'admin@lhave.com', 1, 1, 1418960975, 1418960975, '127.0.0.1');
...
CREATE TABLE IF NOT EXISTS `lhave_category` (
...
--
-- 表的结构 `lhave_category_article`
--

CREATE TABLE IF NOT EXISTS `lhave_category_article` (
...
--
-- 表的结构 `lhave_category_page`
--

CREATE TABLE IF NOT EXISTS `lhave_category_page` (
...
CREATE TABLE IF NOT EXISTS `lhave_config` (
  `name` varchar(250) NOT NULL,
  `data` varchar(250) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='网站配置';

--
-- 转存表中的数据 `lhave_config`
--

INSERT INTO `lhave_config` (`name`, `data`) VALUES
('site_title', '岚海网站后台管理系统'),
('site_subtitle', '简单、易用、轻巧'),
('site_url', ''),
('site_keywords', '岚海网络'),
('site_description', ''),
('site_email', 'admin@lhave.com'),
('site_copyright', 'lhave'),
('site_statistics', ''),
('tpl_name', 'default'),
('tpl_index', 'index'),
('tpl_search', 'search'),
...
--
-- 表的结构 `lhave_config_upload`
--

CREATE TABLE IF NOT EXISTS `lhave_config_upload` (
...
--
-- 转存表中的数据 `lhave_config_upload`
--

INSERT INTO `lhave_config_upload` (`id`, `name`, `upload_size`, `upload_exts`, `upload_replace`, `thumb_status`, `water_status`, `thumb_type`, `thumb_width`, `thumb_height`, `water_image`, `water_position`) VALUES
...
CREATE TABLE IF NOT EXISTS `lhave_content` (
...
--
-- 表的结构 `lhave_content_article`
--

CREATE TABLE IF NOT EXISTS `lhave_content_article` (
...
--
-- 表的结构 `lhave_ext_guestbook`
--

CREATE TABLE IF NOT EXISTS `lhave_ext_guestbook` (
...
--
-- 转存表中的数据 `lhave_ext_guestbook`
--

INSERT INTO `lhave_ext_guestbook` (`data_id`, `name`, `email`, `content`, `time`) VALUES
(1, 'Life', '349865361@qq.com', '欢迎使用LhaveCMS内容管理系统！', 1418960975);
...
CREATE TABLE IF NOT EXISTS `lhave_field` (
...
INSERT INTO `lhave_field` (`field_id`, `fieldset_id`, `name`, `field`, `type`, `tip`, `verify_type`, `verify_data`, `verify_data_js`, `verify_condition`, `default`, `sequence`, `errormsg`, `config`) VALUES
...
CREATE TABLE IF NOT EXISTS `lhave_fieldset` (
...
--
-- 转存表中的数据 `lhave_fieldset`
--

INSERT INTO `lhave_fieldset` (`fieldset_id`, `table`, `name`) VALUES
(1, 'guestbook', '留言板');

-- --------------------------------------------------------

--
-- 表的结构 `lhave_fieldset_expand`
--

CREATE TABLE IF NOT EXISTS `lhave_fieldset_expand` (
  `fieldset_id` int(10) DEFAULT NULL,
...
--
-- 表的结构 `lhave_fieldset_form`
--

CREATE TABLE IF NOT EXISTS `lhave_fieldset_form` (
  `fieldset_id` int(10) DEFAULT NULL,
...
--
-- 转存表中的数据 `lhave_fieldset_form`
--

INSERT INTO `lhave_fieldset_form` (`fieldset_id`, `show_list`, `show_info`, `list_page`, `list_where`, `list_order`, `tpl_list`, `tpl_info`, `post_status`, `post_msg`, `post_return_url`) VALUES
(1, 1, 0, 10, '', 'data_id desc', 'guestbook', 'guestbook', 1, '留言发布成功！', '');

-- --------------------------------------------------------

--
-- 表的结构 `lhave_field_expand`
--

CREATE TABLE IF NOT EXISTS `lhave_field_expand` (
...
--
-- 表的结构 `lhave_field_form`
--

CREATE TABLE IF NOT EXISTS `lhave_field_form` (
  `field_id` int(10) DEFAULT NULL,
...
--
-- 转存表中的数据 `lhave_field_form`
--

INSERT INTO `lhave_field_form` (`field_id`, `post`, `show`, `search`) VALUES
(1, 1, 1, 1),
(2, 1, 1, 1),
(3, 1, 1, 1),
(4, 0, 1, 1);
...
CREATE TABLE IF NOT EXISTS `lhave_file` (
...
CREATE TABLE IF NOT EXISTS `lhave_fragment` (
...
CREATE TABLE IF NOT EXISTS `lhave_position` (
...
--
-- 转存表中的数据 `lhave_position`
--

INSERT INTO `lhave_position` (`position_id`, `name`, `sequence`) VALUES
(1, '首页推荐', 0);
...
CREATE TABLE IF NOT EXISTS `lhave_tags` (
...
CREATE TABLE IF NOT EXISTS `lhave_tags_has` (
  `content_id` int(10) DEFAULT NULL,
...
--
-- 表的结构 `lhave_total_spider`
--

CREATE TABLE IF NOT EXISTS `lhave_total_spider` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `time` int(10) DEFAULT NULL,
...
--
-- 表的结构 `lhave_total_visitor`
--

CREATE TABLE IF NOT EXISTS `lhave_total_visitor` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `time` int(10) DEFAULT NULL,
