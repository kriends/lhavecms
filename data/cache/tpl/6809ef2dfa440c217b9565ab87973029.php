<?php exit;?>0015282568670584b1fd5f4b30a0be3c9f6ae453c46ds:17261:"a:2:{s:8:"template";s:17196:"<form method="post" class="form-x dux-form form-auto" id="form" action="<?php echo url();?>">
                        ...
                        <div class="field">
                               <?php if(!isset($info['gotosub'])){ $info['gotosub'] = 0; }; ?>
                                <div class="button-group button-group-small radio">
                                    ...
                                    <?php } ?>
                                    <span class="icon icon-check"></span> 自身的URL地址</label>
                                    <?php if ($info['gotosub']){ ?>
                                ...
                                <div class="input-note">栏目的url属性定义</div>
                            </div>
                    </div>
...
</script>";s:12:"compile_time";i:1496720867;}";