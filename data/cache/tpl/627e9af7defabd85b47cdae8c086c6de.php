<?php exit;?>0015285353339c2c7f9b5d6da3624314c2934f9ee599s:20802:"a:2:{s:8:"template";s:20737:"<form method="post" class="form-x dux-form form-auto" id="form" action="<?php echo url();?>">
                ...
                <div class="tab-panel active" id="tab-1">
                    <div class="form-group">
                        ...
                        <div class="field">
                            ...
                            <div class="input-note">当前车辆的所属分类</div>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="label">
                        ...
                        <div class="field">
                            ...
                            <div class="input-note">客车标题请不要填写特殊字符</div>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="label">
...
<script>
    ...
    Do.ready('base', function () {
        ...
        $('#getKeyword').click(function () {
            $.post('<?php echo url("lhave/ContentTools/getKerword");?>', {
                    title: $('#content').val(),
		...
		$('#class_id').change(function() {
			$('#expand').load('<?php echo url("lhave/AdminExpand/getField");?>',{class_id:$(this).val(),content_id:$('#content_id').val()},function(){
...
</script>";s:12:"compile_time";i:1496999333;}";