<?php exit;?>001528253930cabe5c228f137bba05c2133a5e10b566s:11186:"a:2:{s:8:"template";s:11121:"<form method="post" class="form-x dux-form form-auto" id="form" action="<?php echo url();?>">
            ...
            <div class="tab-body">
                <div class="tab-panel active" id="tab-1">
                    ...
                    <div class="form-group">
                        ...
                        <div class="field">
                               <?php if(!isset($info['gotosub'])){ $info['gotosub'] = 0; }; ?>
                                <div class="button-group button-group-small radio">
                                    <?php if (!$info['gotosub']){ ?>
                                    <label class="button active"><input name="gotosub" checked="checked" value="0" type="radio">
                                    <?php }else{ ?>
                                    <label class="button"><input name="gotosub" value="0" type="radio">
                                    <?php } ?>
                                    <span class="icon icon-check"></span> 页面自身的URL地址</label>
                                    <?php if ($info['gotosub']){ ?>
                                    <label class="button active"><input name="gotosub" value="1" checked="checked" type="radio">
                                    <?php }else{ ?>
                                    <label class="button"><input name="gotosub" value="1" type="radio">
                                    <?php } ?>
                                    <span class="icon icon-check"></span> 第一个子栏目的URL地址</label>
                                </div>
                                <div class="input-note">页面的url属性定义</div>
                            </div>
                    </div>
...
</script>";s:12:"compile_time";i:1496717930;}";